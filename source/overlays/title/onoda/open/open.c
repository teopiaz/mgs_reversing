...
void title_open_800C4B94(POLY_GT4 *poly, int r0, int g0, int b0, int r, int g, int b)
{
...
void title_open_800C5760(OpenWork *work)
{
    ...
    if (work->fA6C->dir >= 0 && work->fA6C->dir < 512)
    {
        work->fA70 = 0;
        r = work->fAA8.r - 10;
        g = work->fAA8.g + 5;
    ...
    else if (work->fA6C->dir >= 512 && work->fA6C->dir < 1024)
    {
        work->fA70 = 0;
        r = work->fAA8.r - 5;
        g = work->fAA8.g;
    ...
    else if (work->fA6C->dir >= 1024 && work->fA6C->dir < 1536)
    {
        work->fA70 = 0;
        r = work->fAA8.r;
        g = work->fAA8.g - 5;
    ...
    else if (work->fA6C->dir >= 1536 && work->fA6C->dir < 2048)
    {
        work->fA70 = 0;
        r = work->fAA8.r + 5;
        g = work->fAA8.g - 10;
    ...
    else if (work->fA6C->dir >= 2048 && work->fA6C->dir < 2560)
    {
        work->fA70 = 0;
        r = work->fAA8.r + 10;
        g = work->fAA8.g - 5;
    ...
    else if (work->fA6C->dir >= 2560 && work->fA6C->dir < 3072)
    {
        work->fA70 = 0;
        r = work->fAA8.r + 5;
        g = work->fAA8.g;
    ...
    else if (work->fA6C->dir >= 3072 && work->fA6C->dir < 3584)
    {
        work->fA70 = 0;
        r = work->fAA8.r;
        g = work->fAA8.g + 5;
    ...
    else if (work->fA6C->dir >= 3584 && work->fA6C->dir < 4096)
    {
        work->fA70 = 0;
        r = work->fAA8.r - 5;
        g = work->fAA8.g + 10;
...
/* Strings + reverse-transcribed tables for
...
void title_open_800C628C(OpenWork *work)
{
    GCL_ARGS  args;
    long      argv[3];
    ...
    args.argc = 3;
    args.argv = argv;
    press = work->fA6C->press;
    trig = work->fA6C[1].press;
    status = work->fA6C->status;
    argv[0] = work->f24D0;
    argv[1] = work->fB28;
    argv[2] = title_dword_800D92D0;

    if (!(press & 0xFFFF) && !(trig & 0xFFFF))
    {
        work->fB00++;
    }
    else
...
extern void  title_open_800C628C(OpenWork *work);
