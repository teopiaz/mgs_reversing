...
void s08b_bunsin2_800CCD40(BunshinWork *work)
{
    ...
    work->field_19F4 = jimctrl_helper_80037F68(
        *(unsigned short *)((char *)work + 0x50)) & 0xFF;
}
...
{
    char *p = (char *)work->field_8C4;
    unsigned short flag = *(unsigned short *)(p + 6);

    work->field_1A34 = 0;
    if (flag & 4)
    {
        work->field_1A34 = *(short *)(p + 0x3E);
        return;
    }
    if (flag & 2)
    {
        if (*(short *)(p + 0x3E) == 0x24)
        {
            work->field_1A34 = 6;
        }
    }
...
int s08b_bunsin2_800CEF94(BunshinClone *p, int n, int arg2)
{
    int sum = 0;
    int i;
    for (i = 0; i < n; i++)
...
int s08b_bunsin2_800D0F54(BunshinWork *work)
{
    ...
    work->field_19B0 = 7;
    work->field_19B4 = work->field_1A28;
    counter = work->field_19D0;
    if (counter >= 11)
    {
        return 1;
    }
    work->field_19D0 = counter + 1;
    return 0;
}
