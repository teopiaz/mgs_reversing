...
static const char *TRI2D_FS =
    ...
    "        // Treat near-black prev-fb samples as PSX-$0000 transparent\n"
    "        // (matches the discard in tri2d.frag) so the cutscene shows\n"
    "        // through at d00a start before any STP-bit content exists.\n"
